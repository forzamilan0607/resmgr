...
//$validator.checkBankCard("6229180018553877"); 校验银行卡
//$validator.checkIdCard("342225199109102078"); 校验身份证
var $validator = function(){
        ...
        return {
            ...
            validateCardNo: function(cardNo) {
                function getCardTypeName(cardType) {
                    return this.cardTypeMap[cardType] || undefined;
                };
    ...
    return {
        checkBankCard: function(cardNo) {
            return $bankCardValidator.validateCardNo(cardNo);
        },
        checkIdCard: function (idCard) {
            return _checkIdCard(idCard);
        }
    }
}();